...
class BootStrap {
    ...
    def setupDummyData() {
        ...
        Company apple = new Company(companyName: 'Apple')
        ...
        // Leads
        Lead lead1 = new Lead(status: 'Status 1', leadStatus: 'Qualified', leadStage: 'MQL', budget: 'Yes',
        ...
        Lead lead2 = new Lead(status: 'Status 2', leadStatus: 'Qualified', leadStage: 'MQL', budget: 'Yes',
