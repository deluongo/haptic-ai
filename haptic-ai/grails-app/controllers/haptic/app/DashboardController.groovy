...
//        String lastName = params.list('name')?.split(' ')[1]
//
//        if (firstName!=null && lastName!=null) {
//            List<Contact> possibleNewActiveContacts = Contact.findAllByFirstName(firstName)
//            for (contact in possibleNewActiveContacts) {
//                if (contact.getLastName() == lastName) {
//                    activeContact = contact
//                }
//            }
//        }
        println(activeContact.firstName)
    ...
    def contactInfo() {
            ...
            */
            ...
            def firstName = params.list('name')[0].split(' ')[0]
            def lastName = params.list('name')[0].split(' ')[1]
            def jobTitle = params.list('jobTitle')[0]

            for (contact in allContacts) {

                if (contact.getFirstName()==firstName &&
                        contact.getLastName()==lastName && contact.getJobTitle()==jobTitle) {
                    activeContact = contact
                    println('executed')
                }
            }
